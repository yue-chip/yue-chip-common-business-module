...
public interface SmsExposeService {
     ...
     * @return
     */
    public Boolean sendSms(@NotBlank String appId, @NotBlank String signName, @NotBlank String templateCode, @NotBlank Object message, @NotBlank String phoneNumber);
